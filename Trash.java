...
/**
 * Trash Bin Class shows the table of the  promoters removed from the system and allow the user to restore or permanently delete the promoters 
 */
...
public class Trash {
    ...
    public Trash(){
        ...
        String[] positions = {"Restore", "Delete", "Choose"};
     ...
     * @param pList2 This is an array containing the current promoters removed from the system
     */
    ...
    public void addToArray(){
        try{
        BufferedReader br = new BufferedReader(new FileReader("TrashBin.txt"));
        String s;
            ...
            for (int x = 0; x < getTableData(table).length; x++){
                ...
                if(getTableData(table)[x][5].equals("Delete") || getTableData(table)[x][5].equals("Restore")){
                    ...
                    try{
                        ...
                        br.close();
                        FileWriter writer = new FileWriter("TrashBin.txt"); 
